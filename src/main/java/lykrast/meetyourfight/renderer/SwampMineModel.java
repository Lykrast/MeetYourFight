...
public class SwampMineModel extends EntityModel<SwampMineEntity> {
	...
	public SwampMineModel() {
		...
		spikes.setRotationPoint(-6.0F, 10.0F, 6.0F);
		

		bottombackright_r1 = new ModelRenderer(this);
		bottombackright_r1.setRotationPoint(0.0F, 12.0F, 0.0F);
		spikes.addChild(bottombackright_r1);
		setRotationAngle(bottombackright_r1, -2.3562F, -0.7854F, 0.0F);
		bottombackright_r1.setTextureOffset(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		bottombackleft_r1 = new ModelRenderer(this);
		bottombackleft_r1.setRotationPoint(12.0F, 12.0F, 0.0F);
		spikes.addChild(bottombackleft_r1);
		setRotationAngle(bottombackleft_r1, -2.3562F, 0.7854F, 0.0F);
		bottombackleft_r1.setTextureOffset(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		bottomfrontright_r1 = new ModelRenderer(this);
		bottomfrontright_r1.setRotationPoint(0.0F, 12.0F, -12.0F);
		spikes.addChild(bottomfrontright_r1);
		setRotationAngle(bottomfrontright_r1, 2.3562F, 0.7854F, 0.0F);
		bottomfrontright_r1.setTextureOffset(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		bottomfrontleft_r1 = new ModelRenderer(this);
		bottomfrontleft_r1.setRotationPoint(12.0F, 12.0F, -12.0F);
		spikes.addChild(bottomfrontleft_r1);
		setRotationAngle(bottomfrontleft_r1, 2.3562F, -0.7854F, 0.0F);
		bottomfrontleft_r1.setTextureOffset(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		topbackright_r1 = new ModelRenderer(this);
		topbackright_r1.setRotationPoint(0.0F, 0.0F, 0.0F);
		spikes.addChild(topbackright_r1);
		setRotationAngle(topbackright_r1, -0.7854F, -0.7854F, 0.0F);
		topbackright_r1.setTextureOffset(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		topbackleft_r1 = new ModelRenderer(this);
		topbackleft_r1.setRotationPoint(12.0F, 0.0F, 0.0F);
		spikes.addChild(topbackleft_r1);
		setRotationAngle(topbackleft_r1, -0.7854F, 0.7854F, 0.0F);
		topbackleft_r1.setTextureOffset(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		topfrontright_r1 = new ModelRenderer(this);
		topfrontright_r1.setRotationPoint(0.0F, 0.0F, -12.0F);
		spikes.addChild(topfrontright_r1);
		setRotationAngle(topfrontright_r1, 0.7854F, 0.7854F, 0.0F);
		topfrontright_r1.setTextureOffset(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);

		topfrontleft_r1 = new ModelRenderer(this);
		topfrontleft_r1.setRotationPoint(12.0F, 0.0F, -12.0F);
		spikes.addChild(topfrontleft_r1);
		setRotationAngle(topfrontleft_r1, 0.7854F, -0.7854F, 0.0F);
		topfrontleft_r1.setTextureOffset(0, 0).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, 0.0F, false);
	...
	@Override
	public void setRotationAngles(SwampMineEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch){
